...
import { Event, ProvincialAdmin } from "@/types";
  ...
  return (
    <div className=" p-4 min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <AlertDialog
        ...
        onConfirm={async () => {
          if (selectedEvent) {
            await useEventHook.deleteEvent(selectedEvent._id);
      ...
      <AlertDialog
        ...
        onConfirm={async () => {
          if (selectedEvent) {
            ...
            await useEventHook.approveEvent(selectedEvent._id);
            await useEventHook.fetchEvents();
      ...
      <AlertDialog
        ...
        onConfirm={async () => {
          if (selectedEvent) {
            await useEventHook.rejectEvent(selectedEvent._id);
            await useEventHook.fetchEvents();
      ...
      <AlertDialog
        ...
        onConfirm={async () => {
          if (selectedEvent) {
            await useEventHook.endEvent(selectedEvent._id);
            await useEventHook.fetchEvents();
